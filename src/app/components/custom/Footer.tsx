        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Creating innovative e-commerce solutions and IT services for businesses of all sizes.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <span className="text-gray-400">Print-on-Demand</span>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <address className="not-italic text-gray-400">
              ...
              <p className="mt-2">
                <a href="mailto:contact@yourcompany.com" className="hover:text-white transition-colors">
